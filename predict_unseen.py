...
# Load the trained model (try fine-tuned first, then pretrained)
print("Loading model...")
import os

if os.path.exists("matchmaking_model.keras"):
    model_path = "matchmaking_model.keras"
    print("✓ Loading fine-tuned model...")
elif os.path.exists("matchmaking_model_pretrained.keras"):
    model_path = "matchmaking_model_pretrained.keras"
